...
hi_pars.set_cosmology(H0=None, ombh2=0.02222, omch2=0.18, omk=0, tau=0.078, cosmomc_theta = 0.010408)
...
plt.plot(hi_ls[2:], hi_spectrum[2:], label=r'1.5$\Omega_c h^2$ Fit')

# repeat for 0.5*ombh2
lo_pars = camb.CAMBparams()
lo_pars.set_cosmology(H0=None, ombh2=0.02222, omch2=0.06, omk=0, tau=0.078, cosmomc_theta = 0.010408)
...
plt.plot(lo_ls[2:], lo_spectrum[2:], label=r'0.5$\Omega_c h^2$ Fit')
...
print(r'1.5$\Omega_c h^2$ reduced $\chi^2$ =', hi_chisq)
print(r'0.5$\Omega_c h^2$ reduced $\chi^2$ =', lo_chisq)
